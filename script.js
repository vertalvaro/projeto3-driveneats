function selectDishes(select) {
    let unselect = document.querySelector(".dishes .selected")
    if (unselect !== null) {
...
function selectDrinks(select) {
    let unselect = document.querySelector(".drinks .selected")
    if (unselect !== null) {
        unselect.classList.remove("selected")
    }
    select.classList.add("selected");
...
function selectDesserts(select) {
    let unselect = document.querySelector(".desserts .selected")
    if (unselect !== null) {
        unselect.classList.remove("selected")
    }
    select.classList.add("selected");
